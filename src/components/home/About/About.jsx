...
import { FaFacebook, FaRegSmileWink, FaGoogle, FaInstagram, FaLinkedin, FaMailBulk, FaTwitter, FaWhatsapp, FaCode, FaCodeBranch, FaUsers, FaLightbulb } from "react-icons/fa"
...
const data = [
    {
        ...
        icon: <FaCode className="text-[2rem]"/>
    },
    {
        ...
        icon: <FaCodeBranch className="text-[2rem]"/>
    },
    {
        ...
        icon: <PiBooksFill className="text-[2rem]"/>
    },
    {
        ...
        icon: <FaUsers className="text-[2rem]"/>
    },
    {
        ...
        icon: <FaLightbulb className="text-[2rem]"/>
    },
    {
        ...
        icon: <GoStarFill className="text-[2rem]"/>
    }
]
